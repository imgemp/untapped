...
from untapped.M12 import L2, KL, binary_cross_entropy
...
for trial in range(num_trials):
  ...
  m = SSDGM(num_features,num_output,variational=True,model_dict=model_dict,eq_samples=1,iw_samples=1,
            ...
            coeff_x=1e-1,coeff_y=0,coeff_x_dis=1,coeff_y_dis=0,coeff_x_prob=1e-1,coeff_y_prob=0,
            num_epochs=1500,eval_freq=100,lr=1e-3,
